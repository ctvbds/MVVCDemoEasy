...
//    var detailTextLabel: UILabel!
    ...
    override func layoutSubviews() {
        lbName.frame =  CGRect(x: 0, y: 5, width: contentView.frame.size.width, height: 30)
        lbPrice.frame =  CGRect(x: 0, y: lbName.frame.size.height + 5, width: contentView.frame.size.width, height: 30)
